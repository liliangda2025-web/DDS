-- 知识库模块初始化脚本。
-- 表结构和测试数据以 doc/knowledge/知识库模块数据库设计.md 为设计基准。
...
VALUES (2100000000000000001, 'DRAWING', 'DWG-HVAC-001', '总部办公楼暖通空调设计图1',
        '总部 办公楼 暖通 空调 设计',
        'V1.0', '总部办公楼项目', '2026-06-26',
        '图纸库', 'HVAC', '张工', '内部',
        1, 1, NULL, NULL, NOW(), NOW()),
       (2100000000000000002, 'DRAWING', 'DWG-CIVIL-002', '高端小区地下车库人防工程施工图2',
        '高端小区 地下车库 人防 工程 施工图',
        'V1.0', '高端小区项目', '2026-06-26',
        '图纸库', 'CIVIL', '李工', '内部',
        1, 1, NULL, NULL, NOW(), NOW()),
       (2100000000000000003, 'DRAWING', 'DWG-ARCH-003', '实验中学建筑竣工图3',
        '实验中学 建筑 竣工图',
        'V1.0', '实验中学项目', '2026-06-25',
        '图纸库', 'ARCH', '王工', '普通',
        1, 1, NULL, NULL, NOW(), NOW()),
       (2100000000000000004, 'DRAWING', 'DWG-FIRE-004', '人民医院消防专项设计图4',
        '人民医院 消防 专项 设计图',
        'V1.0', '人民医院项目', '2026-06-25',
        '图纸库', 'FIRE', '赵工', '内部',
        1, 1, NULL, NULL, NOW(), NOW()),
       (2100000000000000005, 'DRAWING', 'DWG-DRAIN-005', '商业综合体给排水系统图5',
        '商业综合体 给排水 排水 系统图',
       ...
       (2100000000000000008, 'CASE', 'CASE-CONFLICT-001', '暖通与消防管线冲突案例',
        ...
        '案例库', 'HVAC', '案例管理员', '内部',
        1, 1, NULL, NULL, NOW(), NOW()),
       (2100000000000000009, 'DRAWING', 'TMP_2100000000000000009', 'f_2de134a04349',
        '待补充',
        'TEMP', NULL, NULL,
        '图纸库', NULL, NULL, NULL,
        0, 1, NULL, NULL, NOW(), NOW()),
       (2100000000000000010, 'DRAWING', 'TMP_2100000000000000010', 'history11',
        '待补充',
        'TEMP', NULL, NULL,
        '图纸库', NULL, NULL, NULL,
        0, 1, NULL, NULL, NOW(), NOW());
